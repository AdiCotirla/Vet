  ...
  return (
    ...
    <div className='footer-container'>
      <div className='footer-logo'>
        ...
        <a href="tel:+0746878517" className='links-footer'><BsIcons.BsFillTelephoneFill className='icon'/><p>07468785117</p></a>
        <a href="mailto:adioprea@gmail.com" className='links-footer'><IoIcons.IoPaperPlaneOutline  className='icon'/><p>Trimite email</p></a>
       <div className='icons-container'>
        <a href="https://www.instagram.com" className='links-footer-apps instagram'><FaIcons.FaInstagram className='apps'/></a>
        <a href="https://www.facebook.com" className='links-footer-apps facebook'><GrIcons.GrFacebookOption className='apps'/></a>
        <a href="https://www.w3schools.com/" className='links-footer-apps linkedin'> <FaIcons.FaLinkedinIn className='apps'/></a>
      </div>
      </div>
